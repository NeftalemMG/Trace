# AiEO Visibility Audit Tool

University of Windsor · AIEO Challenge 2026  
Faisal Al-Durra · Neftalem Gebremical · Utkarsh Kanade

---

A real-time platform that audits, scores, and fixes how AI systems represent Canadian organizations, programs, and opportunities. Every tool makes live API calls — no simulated data.

Built with Next.js 14, Tailwind CSS, Space Grotesk / Syne / Bebas Neue / Space Mono, and the Anthropic API.
...
Indigenous-led tech scored 28/100 visibility versus 82/100 for major urban ecosystems — a 54-point equity gap.
